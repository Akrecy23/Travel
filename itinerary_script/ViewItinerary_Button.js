...
async function openItineraryModal(currentUserId, yearId, countryId, groupId, tripId) {
  ...
  function renderDay(dayIndex) {
    ...
    entries.forEach((entry, i) => {
      ...
      entry.querySelector(".edit-btn").addEventListener("click", () => {
        ...
        enableActivityEditing(entry, currentUserId, yearId, countryId, groupId, tripId, day.day, activity.id);
      });
      // For delete button
      entry.querySelector(".delete-btn").addEventListener("click", async () => {
        deleteActivity(currentUserId, yearId, countryId, groupId, tripId, day.day, activity.id, entry);
      });
    });
