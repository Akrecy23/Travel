// THIS FILE IS PART 3 OF ACTIVITYDETAILS_CARD.JS
// CREATE THE CARDS USING HTML

// HELPER: BUILD CARD ELEMENT
function createActivityCard(data, activityType) {
  const card = document.createElement("div");
  card.className = "activity-card";
  const typeClass = activityType.toLowerCase().replace(/\s+/g, "-");
    ...
    <div class="card-inner">
        ...
        <div class="card-content">
          ...
          <div class="card-header">
            <div class="title-type-group">
              ...
              <p class="activity-type ${typeClass}">${activityType}</p>
            </div>
          ...
          <div class="remarks-section">
            <div class="remarks-header">
              ...
              <div class="card-actions-remarks">
                <button class="edit-btn" title="Edit remarks">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" 
                    stroke="currentColor" stroke-width="2">
                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14
                            a2 2 0 0 0 2-2v-7"></path>
      ...
      <div class="card-face card-back">
        <div class="back-header">
          ...
          <p class="back-type">${activityType}</p>
        </div>
