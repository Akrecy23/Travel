...
function createFoodCard(data) {
  ...
  // Check if food is already in revisit
    ...
    <div class="card-inner">
      ...
      <div class="card-face card-front">
        ...
        <div class="card-image">
          ...
          <!-- Save/Heart Button -->
          <button class="save-btn ${data.Saved ? 'active' : ''}" data-food-id="${data.id || ''}">
        ...
        <div class="card-content">
          ...
          <div class="card-header">
            <div class="title-type-group">
              ...
              <p class="food-type ${typeClass}">${data.Type || "-"}</p>
            </div>
          ...
          <div class="food-actions-row dual-buttons">
            ...
            <button class="${classRevisit}" data-food-id="${data.id}">
              ${isMarkedRevisit ? "Remove from Revisit" : "Add to Revisit"}
            </button>
            <!-- Go to Map Button -->
            <button class="map-btn" data-food-id="${data.id}">
          ...
          <button class="trip-btn" data-food-id="${data.id}"> ➕ Add to Trip </button>
