...
document.addEventListener("DOMContentLoaded", () => {
  // Example: pass true for toggle, false for dropdown
...
function createHomeFrontLayout() {
  ...
  const pageTitle = document.title; // e.g. "Travel Web"

  // Decide which right-side control to render
